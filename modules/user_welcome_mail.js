              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    <!-- <p>Hi, {{ name }}</p> -->
                    <p>Hello {{ name }},</p>
                    <p>Thank you for using {{ siteName }}. Please use the OTP below to confirm your email address.</p>
                    <!-- Action -->
                      ...
                      <tr>
                        <td align="center">
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                              <tr>
                                  <!-- <td style=" text-align: center; border-radius: 3px;" class="button button--blue color-white">
                                  ...
                                  <span style="color:#ffffff">Confirm Email Address</span>
                                  </a>
                                  </td> -->
                                  OTP: {{ otp }}
                              </tr>
                    ...
                    <p>Have a great day!<br>Team {{ siteName }}</p>
                    <!-- Sub copy -->
                    <!-- <table class="body-sub">
                      <tr>
                        <td>
                          ...
                          <p class="sub"><a href="{{ email_validation_url }}">{{ email_validation_url }}</a></p>
                        </td>
                      </tr>
                    </table> -->
                  </td>
